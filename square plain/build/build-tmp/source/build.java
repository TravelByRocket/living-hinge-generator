...
float anchorWeightTips = 0.6f; // distance factor from anchor to place control point, multipled by cellWidth
...
class HingeArea{
	...
	// ADJUST PADDING
	public void decreasePaddingH(){
		cellPaddingH--;
	}
	public void increasePaddingH(){
		cellPaddingH++;
	}
	public void decreasePaddingV(){
		cellPaddingV--;
	}
	public void increasePaddingV(){
		cellPaddingV++;
	}
	...
	public void increaseCellHeight(){
		cellHeight++;
	}
...
class Cell{
	...
	public void draw(int _x0, int _y0, int _cellWidth, int _cellHeight){
...
public void makeOutline(int _x0, int _y0, int _x1, int _y1){
	if (showGuides) {
		noFill();
